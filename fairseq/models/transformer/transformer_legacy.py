...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_100m")
def transformer_vaswani_wmt_en_de_100m(args):
...
@register_model_architecture("transformer", "transformer_nllb_600m_moe")
def transformer_nllb_600m_moe(args):
...
@register_model_architecture("transformer", "transformer_nllb_1b_moe")
def transformer_nllb_1b_moe(args):
    args.share_all_embeddings = getattr(args, "share_all_embeddings", True)
